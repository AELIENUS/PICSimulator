...
public class OperationService
{
    ...
    public OperationService(Memory memory, SourceFileModel srcModel)
    {
        _memory = memory;
        _srcModel = srcModel;
    }
    ...
    public ResultInfo ADDWF(int file, int d) //add w and f 
    {
        ...
        return new ResultInfo()
        {
            ...
            {
                new OperationResult()
                    {Value = result, Address = Convert.ToBoolean(d) ? file : Constants.WRegPlaceholder}
            },
        };
    }
    ...
    public ResultInfo CLRW() // clear w
    {
        return new ResultInfo()
        {
            ...
            {
                new OperationResult()
                    {Value = 0, Address = Constants.WRegPlaceholder}
            },
        };
    }
    ...
    public ResultInfo RRF (int file, int d) // rotate right through carry
    {
        ...
        return new ResultInfo()
        {
            ...
            {
                new OperationResult()
                    {Value = operationResult, Address = Convert.ToBoolean(d) ? file : Constants.WRegPlaceholder}
            },
        };
    }
    ...
    public ResultInfo ADDLW (int literal) //add literal and w
    {
        ...
        return new ResultInfo()
        {
            ...
            {
                new OperationResult()
                    {Value = result, Address = Constants.WRegPlaceholder}
            },
        };
    }
    ...
    public ResultInfo GOTO (int address) //go to address
    {
        ...
        int newPC = address + ((_memory.RAM[Constants.PCLATH_B1] & 0b_0001_1000) << 8);
        //Calculate PCL 
        ...
        return new ResultInfo()
        {
            ...
            {
                new OperationResult()
                    {Value = newPCL, Address = Constants.PCL_B1}
            },
        };
    }
    ...
    public ResultInfo RETFIE() //return from interrupt -> fertig
    {
        ...
        int value = _memory.RAM[Constants.INTCON_B1] | 0b_1000_0000;
        return new ResultInfo()
        {
            ClearISR = true,
            Cycles = 2,
            ...
            {
                new OperationResult()
                    {Value = returnAddress, Address = Constants.PCL_B1},
                new OperationResult()
                    {Value = value, Address = Constants.INTCON_B1}
            },
        };
    }
    ...
    public ResultInfo RETLW (int literal) //return with literal in w -> fertig
    {
        ...
        return new ResultInfo()
        {
            ...
            {
                new OperationResult()
                    {Value = literal, Address = Constants.WRegPlaceholder},
                new OperationResult()
                    {Value = returnAddress, Address = Constants.PCL_B1}
            },
        };
    ...
    public ResultInfo SLEEP() // go into standby mode 
    {
        ...
        return new ResultInfo()
        {
            ...
            {
                new OperationResult()
                    {Value = result, Address = Constants.STATUS_B1},
            },
        };
    }
